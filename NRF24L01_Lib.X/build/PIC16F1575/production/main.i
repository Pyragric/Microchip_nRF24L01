...
# 1 "main.c" 2
# 21 "main.c"
# 1 "./01 - SRC/05_MCC_16F1575/mcc.h" 1
# 49 "./01 - SRC/05_MCC_16F1575/mcc.h"
...
# 49 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/device_config.h" 1
# 50 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/pin_manager.h" 1
# 227 "./01 - SRC/05_MCC_16F1575/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 239 "./01 - SRC/05_MCC_16F1575/pin_manager.h"
void PIN_MANAGER_IOC(void);
# 252 "./01 - SRC/05_MCC_16F1575/pin_manager.h"
void IOCAF5_ISR(void);
# 275 "./01 - SRC/05_MCC_16F1575/pin_manager.h"
void IOCAF5_SetInterruptHandler(void (* InterruptHandler)(void));
# 299 "./01 - SRC/05_MCC_16F1575/pin_manager.h"
extern void (*IOCAF5_InterruptHandler)(void);
# 323 "./01 - SRC/05_MCC_16F1575/pin_manager.h"
void IOCAF5_DefaultInterruptHandler(void);
# 51 "./01 - SRC/05_MCC_16F1575/mcc.h" 2
...
# 52 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\stdbool.h" 1 3
# 53 "./01 - SRC/05_MCC_16F1575/mcc.h" 2
...
# 54 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/interrupt_manager.h" 1
# 55 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/pwm1.h" 1
# 94 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_Initialize(void);
# 123 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_Start(void);
# 155 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_Stop(void);
# 180 "./01 - SRC/05_MCC_16F1575/pwm1.h"
_Bool PWM1_CheckOutputStatus(void);
# 203 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_LoadBufferSet(void);
# 226 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_PhaseSet(uint16_t phaseCount);
# 249 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_DutyCycleSet(uint16_t dutyCycleCount);
# 272 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_PeriodSet(uint16_t periodCount);
# 295 "./01 - SRC/05_MCC_16F1575/pwm1.h"
void PWM1_OffsetSet(uint16_t offsetCount);
# 318 "./01 - SRC/05_MCC_16F1575/pwm1.h"
uint16_t PWM1_TimerCountGet(void);
# 342 "./01 - SRC/05_MCC_16F1575/pwm1.h"
_Bool PWM1_IsOffsetMatchOccured(void);
# 366 "./01 - SRC/05_MCC_16F1575/pwm1.h"
_Bool PWM1_IsPhaseMatchOccured(void);
# 390 "./01 - SRC/05_MCC_16F1575/pwm1.h"
_Bool PWM1_IsDutyCycleMatchOccured(void);
# 414 "./01 - SRC/05_MCC_16F1575/pwm1.h"
_Bool PWM1_IsPeriodMatchOccured(void);
# 56 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/tmr1.h" 1
# 100 "./01 - SRC/05_MCC_16F1575/tmr1.h"
void TMR1_Initialize(void);
# 129 "./01 - SRC/05_MCC_16F1575/tmr1.h"
void TMR1_StartTimer(void);
# 161 "./01 - SRC/05_MCC_16F1575/tmr1.h"
void TMR1_StopTimer(void);
# 196 "./01 - SRC/05_MCC_16F1575/tmr1.h"
uint16_t TMR1_ReadTimer(void);
# 235 "./01 - SRC/05_MCC_16F1575/tmr1.h"
void TMR1_WriteTimer(uint16_t timerVal);
# 271 "./01 - SRC/05_MCC_16F1575/tmr1.h"
void TMR1_Reload(void);
# 310 "./01 - SRC/05_MCC_16F1575/tmr1.h"
void TMR1_StartSinglePulseAcquisition(void);
# 349 "./01 - SRC/05_MCC_16F1575/tmr1.h"
uint8_t TMR1_CheckGateValueStatus(void);
# 387 "./01 - SRC/05_MCC_16F1575/tmr1.h"
_Bool TMR1_HasOverflowOccured(void);
# 57 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/tmr0.h" 1
# 63 "./01 - SRC/05_MCC_16F1575/tmr0.h"
extern volatile uint16_t TimerTick1ms;
# 99 "./01 - SRC/05_MCC_16F1575/tmr0.h"
void TMR0_Initialize(void);
# 130 "./01 - SRC/05_MCC_16F1575/tmr0.h"
uint8_t TMR0_ReadTimer(void);
# 169 "./01 - SRC/05_MCC_16F1575/tmr0.h"
void TMR0_WriteTimer(uint8_t timerVal);
# 205 "./01 - SRC/05_MCC_16F1575/tmr0.h"
void TMR0_Reload(void);
# 220 "./01 - SRC/05_MCC_16F1575/tmr0.h"
void TMR0_ISR(void);
# 239 "./01 - SRC/05_MCC_16F1575/tmr0.h"
 void TMR0_SetInterruptHandler(void (* InterruptHandler)(void));
# 257 "./01 - SRC/05_MCC_16F1575/tmr0.h"
extern void (*TMR0_InterruptHandler)(void);
# 275 "./01 - SRC/05_MCC_16F1575/tmr0.h"
void TMR0_DefaultInterruptHandler(void);
# 58 "./01 - SRC/05_MCC_16F1575/mcc.h" 2

# 1 "./01 - SRC/05_MCC_16F1575/eusart.h" 1
# 75 "./01 - SRC/05_MCC_16F1575/eusart.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
# 110 "./01 - SRC/05_MCC_16F1575/eusart.h"
void EUSART_Initialize(void);
# 158 "./01 - SRC/05_MCC_16F1575/eusart.h"
_Bool EUSART_is_tx_ready(void);
# 206 "./01 - SRC/05_MCC_16F1575/eusart.h"
_Bool EUSART_is_rx_ready(void);
# 253 "./01 - SRC/05_MCC_16F1575/eusart.h"
_Bool EUSART_is_tx_done(void);
# 301 "./01 - SRC/05_MCC_16F1575/eusart.h"
eusart_status_t EUSART_get_last_status(void);
# 321 "./01 - SRC/05_MCC_16F1575/eusart.h"
uint8_t EUSART_Read(void);
# 341 "./01 - SRC/05_MCC_16F1575/eusart.h"
void EUSART_Write(uint8_t txData);
# 361 "./01 - SRC/05_MCC_16F1575/eusart.h"
void EUSART_SetFramingErrorHandler(void (* interruptHandler)(void));
# 379 "./01 - SRC/05_MCC_16F1575/eusart.h"
void EUSART_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 397 "./01 - SRC/05_MCC_16F1575/eusart.h"
void EUSART_SetErrorHandler(void (* interruptHandler)(void));
# 59 "./01 - SRC/05_MCC_16F1575/mcc.h" 2
# 74 "./01 - SRC/05_MCC_16F1575/mcc.h"
void SYSTEM_Initialize(void);
# 87 "./01 - SRC/05_MCC_16F1575/mcc.h"
void OSCILLATOR_Initialize(void);
# 99 "./01 - SRC/05_MCC_16F1575/mcc.h"
void WDT_Initialize(void);
# 21 "main.c" 2

# 1 "./01 - SRC/01_Appli/Application.h" 1
# 18 "./01 - SRC/01_Appli/Application.h"
...
# 14 "./01 - SRC/03_NRF24L01/NRF24L01.h"
...
void main(void)
{
    ...
    while (1)
    {
        ...
        if (TimerTick1ms > Timeout_100ms)
        {




            Timeout_100ms = TimerTick1ms + 100u;
        }
        else
        {
        }
